...
import com.charlie.model.HttpClientResult;
...
public class HttpUtils
{
    ...
    private static final Map<String, Byte> mobileAgents = new HashMap<>();

    static
    {
        String[] agents = {"iphone", "android", "ipad", "phone", "mobile", "wap", "netfront", "java", "opera mobi",
                ...
                "Googlebot-Mobile"};
        for (String mobileAgent : agents)
        {
            mobileAgents.put(mobileAgent, (byte) 1);
        }
    }
    ...
    public static boolean JudgeIsMoblie(HttpServletRequest request)
    {
        ...
        if (request.getHeader("User-Agent") != null)
        {
            ...
            if (mobileAgents.containsKey(agent)) return true;
            return false;
        }
        return isMoblie;
    }

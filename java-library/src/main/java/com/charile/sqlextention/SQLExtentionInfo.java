...
public class SQLExtentionInfo<T extends AbstractSQLExtentionModel>
{
	...
	private AbstractSQLExtentionpProxyBaseCRUDDao<T> proxyDao;
	...
	public void setProxyDao(AbstractSQLExtentionpProxyBaseCRUDDao<?> dao)
	{
		this.proxyDao=(AbstractSQLExtentionpProxyBaseCRUDDao<T>) dao;
	}

...
func (b *VlinkChainCodeBaseLogicServiceImpl) PutByKeyWithDecorate(configReq base.BCPutStateReq, data interface{}, decorater func([]byte) []byte) error2.IVlinkError {
...
func (b *VlinkChainCodeBaseLogicServiceImpl) buildBytes(configReq base.BCPutStateReq, data interface{}) ([]byte, error2.IVlinkError) {
	if configReq.Key == "" {
	...
	if configReq.NeedEncrypt {
		...
		if nil != vlinkError {
			...
			return nil, error2.ErrorsWithMessage(vlinkError, "加密失败")
		}
		values = encrypt
...
func (b *VlinkChainCodeBaseLogicServiceImpl) PutByKey(configReq base.BCPutStateReq, data interface{}) error2.IVlinkError {
	if configReq.Key == "" {

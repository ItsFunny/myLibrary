...
var GO_ID_HOOK = func(entry zapcore.Entry) error {
	// goId := trace.CurGoroutineID()
	// entry.Message = fmt.Sprintf("当前协程:[%d],", goId)
	return nil
}
...
func NewFabricLogger(l *zap.Logger, options ...zap.Option) *FabricLogger {
	return &FabricLogger{
		s: l.WithOptions(append(options, zap.AddCallerSkip(1), zap.Hooks(GO_ID_HOOK))...).
			Sugar(),
	}
}
...
func decorateMsg(msg string) string {
	return fmt.Sprintf("当前协程:[%d]", trace.CurGoroutineID()) + "," + msg
}
...
func (f *FabricLogger) DPanicw(msg string, kvPairs ...interface{}) {
	f.s.DPanicw(decorateMsg(msg), kvPairs...)
}
...
func (f *FabricLogger) Debugw(msg string, kvPairs ...interface{}) {
	f.s.Debugw(decorateMsg(msg), kvPairs...)
}
...
func (f *FabricLogger) Errorw(msg string, kvPairs ...interface{}) {
	f.s.Errorw(decorateMsg(msg), kvPairs...)
}
...
func (f *FabricLogger) Fatalw(msg string, kvPairs ...interface{}) {
	f.s.Fatalw(decorateMsg(msg), kvPairs...)
}
...
func (f *FabricLogger) Infow(msg string, kvPairs ...interface{}) {
	f.s.Infow(decorateMsg(msg), kvPairs...)
}
...
func (f *FabricLogger) Panicw(msg string, kvPairs ...interface{}) {
	f.s.Panicw(decorateMsg(msg), kvPairs...)
}
...
func (f *FabricLogger) Warnw(msg string, kvPairs ...interface{}) {
	f.s.Warnw(decorateMsg(msg), kvPairs...)
}
...
func formatArgs(args []interface{}) string {
	return fmt.Sprintf("当前协程:[%d]", trace.CurGoroutineID()) + "," + strings.TrimSuffix(fmt.Sprintln(args...), "\n")
}

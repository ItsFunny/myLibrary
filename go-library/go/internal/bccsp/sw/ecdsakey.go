...
func (k *ecdsaPrivateKey) GetOrigin() interface{} {
	return k.privKey
}

func (k *ecdsaPrivateKey) ToCryptoSigner() crypto.Signer {
	return k.privKey
}

func (k *ecdsaPrivateKey) GetPublicKey() (bccsp.IPublicKey, error) {
...
func (k *ecdsaPublicKey) GetOrigin() interface{} {
	return k.pubKey
}
